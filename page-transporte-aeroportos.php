...
<title>Dezidério Transporte - Serviços</title>
...
<!-- Popup APP-->
		...
		<div class="page-top blackish overlape">
			<div class="parallax" data-velocity="-.1" style="background: url('images/parallax200.jpg') repeat scroll 0 0"></div>
			<div class="container">
				<div class="page-title">
					<span>CONHEÇA O SERVIÇO DE</span>
					<h3>TRNSPORTE PARA AEROPORTOS</h3>
				</div><!-- Page Title -->
			</div>
		</div><!-- Page Top -->
									...
									<div class="services-details">
										<div class="service-detail-post">
											...
											<div class="services-info">
												...
												<span>Atualizado em 19/10/2017</span>
											</div>
										</div>
										...
										<div class="tab-content">
											<div role="tabpanel" class="tab-pane fade in active" id="description">
												<div class="services-tabs-content">
													<p itemprop="description">Este serviço é destinado para clientes específicos, seja uma pessoa ou grupo. Nossa experiencia permite produzir toda a logística necessária de forma otimizada e dinamica, assim garantimos que nossos passageiros chegem com pontualidade e segurança em seus destinos.</p>
													
												</div>
											</div>
											<div role="tabpanel" class="tab-pane fade" id="chart">
												<div class="services-tabs-content">
													<p itemprop="description">Para contratar o serviço de Transporte para Aeroportos da Dezidério Transportes é simples. Envie-nos uma mensagem e nossa equipe logo retornará o contato.</p>
													<div class="chart-detail">
														<div class="row">
															<div class="col-md-6">
																<div class="chart-rating">
																	<div id="rating-chart" data-startdegree="60" data-dimension="250" data-text="21%" data-info="De procura no site" data-width="7" data-fontsize="30" data-percent="21" data-fgcolor="#f5b120" data-bgcolor="#ededed"></div>
																</div>
															</div>
															<div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 column">
                            <ul>
                                ...
                                <li><a itemprop="url" href="servicos.html" title="">SERVIÇOS</a></li>
                                <li><a itemprop="url" href="#itinerarios" title="">ITINERÁRIOS</a></li>
                                <li><a itemprop="url" href="about.html" title="">CONTATO</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
